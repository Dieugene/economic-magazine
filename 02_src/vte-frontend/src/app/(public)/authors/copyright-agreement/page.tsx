...
function CopyrightRu() {
  return (
    <div className="prose max-w-none text-gray-700 leading-relaxed text-sm space-y-4">
      <p>
        <strong>Автор/соавторы</strong> безвозмездно предоставляет(-ют) ФГБУН Институт экономики Российской академии наук (далее — Институт) право на публикацию в журнале «Вопросы теоретической экономики» в электронном формате своего Произведения, изложенного в виде статьи и приложений к ней (при наличии).
      </p>
      ...
      <p className="pt-2">Автор/соавторы гарантирует, что:</p>
      ...
      <p className="pt-2">Автор/соавторы предоставляет Институту право обработки следующих своих персональных данных без ограничения по сроку:</p>
      <ul className="list-disc list-inside space-y-1.5 ml-2">
...
function CopyrightEn() {
  return (
    <div className="prose max-w-none text-gray-700 leading-relaxed text-sm space-y-4">
      ...
      <p className="pt-2">The author/co-authors guarantee that:</p>
      <ul className="list-disc list-inside space-y-2 ml-2">
      ...
      <p className="pt-2">The author/co-authors grant(s) the Institute the right to process the following personal data without time limit:</p>
      <ul className="list-disc list-inside space-y-1.5 ml-2">
